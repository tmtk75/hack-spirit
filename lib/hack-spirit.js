  ...
  * inputWorkTimeOfProjects(totalDuration, projectObjects) {
    ...
    while (true) {
      let projects = yield prompt.scanWorkTimeOfProjects(totalDuration,
                                                         projectObjects);
      if (!this.calculateProjects(projects, totalDuration)) {
  ...
  calculateProjects(projects, totalDuration) {
    ...
    let restDuration = relatives.reduce((t, p) => {
      console.log(p.totalDuration.format('h:mm'));
      console.log(p.getDuration().format('h:mm'));
      return t.subtract(p.getDuration());
    }, totalDuration);
    console.log(restDuration.format('h:mm'));
